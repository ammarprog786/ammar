...
logo ="""
 \033[1;96m ------------------------
 \033[1;32m < OFFICIAL CODER AMMAR >
 \033[1;96m ------------------------
\033[1;96m
  =====================================================
|                  ASSALAMU ALAIKUM                     |
|              Coded By : MUHAMMAD Ammar              |
|              Facebook : AMMAR RAZA KHOKHAR            |
|      Editing My Script Will Not Make You  a Coder     | 
|         AMMAR THE OFFICIAL PROGRAMMER [ A.O.P]   |
|               Whatsapp : +92 348 49331362              |
  =====================================================
\033[1;97m
------------------------------------+-----------------
uuuuuuu
...
033[1;32m                               _____  
   ...
   / /\ \ | '_ ` _ \| '_ ` _ \  / /\ \ |  _  / 
  / ____ \| | | | | | | | | | |/ ____ \| | \ \ 
 /_/    \_\_| |_| |_|_| |_| |_/_/    \_\_|  \_\ (ON FIRE)"""
...
jalan('\033[1;96m---> \033[1;32mAMMAR THE OFFICIAL PROGRAMMER \033[1;31m[ A.O.P ]')
print "\033[1;96m----->\033[1;32mTOOL LOGIN \033[1;96m<-----"

CorrectUsername = "ammar"
CorrectPassword = "ammar"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://wa.me/+923484933136')
    else:
        print "\033[1;31mACCESS DENIED"
        os.system('xdg-open https://wa.me/+923484933136')
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdhttps://wa.me/+923484933136')
...
def menu():
	...
	print "\033[1;32m<-----\033[1;93mAMMAR THE OFFICIAL PROGRAMMER㋡ A•O•P㋡\033[1;32m----->"
	print "\033[1;97m-------------------------------"
...
def pilih_super():
	...
	jalan(' \033[1;32m<-----\033[1;93mAMMAR THE OFFICIAL PROGRAMMER㋡ A•O•P㋡\033[1;32m----->')
	jalan(' \033[1;97m-----------------------------------')
	...
	p.map(main, id)
	print "\033[1;32m<-----\033[1;93mAMMAR THE OFFICIAL PROGRAMMER㋡ A•O•P㋡\033[1;32m----->"
	print "  \033[1;93m<-----Developed By Muhammad AMMAR----->" #Dev:hamza
...
______________¶¶¶¶¶¶¶¶¶¶¶¶
 ...
 Having Problem Whatsapp Me :+923484933136"""
